...
#Requirement #7.4.1 Generate Customized User Menu
...
#Requirement 7.7.3 -  Delivery provider live tracking and IFRAME - cannot be tested 

#Requirement 7.7.4 - Delivery driver tracking for restaurant 
...
#Requirement 7.7.5 - Ready for pickup alert cannot be tested because alert is a UI function that is out of scope for our testing 

#Requirement 7.8 - Comments section 
...
#Requirement 7.8.1 - Verified customers can post comments and feedback
...
#Requirement 7.8.2 - Share experiences and seasonal recipe Wishlist
